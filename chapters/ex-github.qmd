...
Maintenant, nous souhaitons envoyer notre projet sur GitHub. Rendez-vous sur GitHub et créez un nouveau dépôt **VIDE** : donnez juste un nom de dépôt et n'ajoutez **aucun fichier supplémentaire** (pas de licence, `.gitignore`, `README`). Le dépôt contient une série d'instructions correspondant à trois cas de figure. Nous allons suivre la section **_Push an existing repository from the command line_**.
