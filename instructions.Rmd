...
Click on _base_
<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`r fontawesome::fa_i("caret-right")` &nbsp;
Click on _Download R 4.2.2 for Windows_
<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`r fontawesome::fa_i("caret-right")` &nbsp;
Open _R-4.2.2-win.exe_ and follow instructions.
...
Download the 64-bit version for Windows
<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`r fontawesome::fa_i("caret-right")` &nbsp;
Open _Git-2.38.1-64-bit.exe_ and follow instructions
...
wget https://github.com/quarto-dev/quarto-cli/releases/download/v1.2.267/quarto-1.2.267-linux-amd64.deb

## Install Quarto ----
sudo dpkg -i quarto-1.2.267-linux-amd64.deb

## Remove installer ----
rm quarto-1.2.267-linux-amd64.deb
```
