...
<table>
  ...
  <tr>
    ...
    <td>Open science & Reproducible research</td>
  </tr>
  <tr>
    <td>Research compendium & Good practices</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Literate programing: `R Markdown` & `Quarto`</td>
  </tr>
  <tr>
    <td>Pipeline toolkit with `targets`</td>
  </tr>
  
  <tr>
    <td rowspan="3">**Wednesday**</td>
    <td>Dealing with R package versions with `renv`</td>
  </tr>
  <tr>
    <td>Containerization with `Docker`</td>
  </tr>
  <tr>
    <td>Building an R package</td>
  </tr>
